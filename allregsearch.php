...
<head>
    <meta charset="UTF-8">
    <title>Report- <?php echo $showterm ?> in The <?php echo $table ?> Register in <?php echo $term ?> </title>
...
<body>
   ...
   <div id="verify">
    <form name="search" action="allregsearch "  method="post">
               ...
               &nbsp;&nbsp;
                ...
                <font  class="pull-center" color="red"><?php echo $count ?> Record(s) Found for <?php echo $term ?> YOA</font>
                </form>
       </div>
       </div>
                <hr>
