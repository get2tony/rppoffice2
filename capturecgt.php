...
$cgtrate=getSetting('whtrate',$conn);
...
<body onload="reboot();">
   <div class="container-fluid">
           ...
           <div class="note2" ><h3> &nbsp;Raise Registered Assessments ( CAPITAL GAINS TAX )</h3>
            </div>
            <form id="returns" name="returns" action="doasscgt " onsubmit="return validateForm()" method="post" target="dframe">
       <div class="row-fluid col-md-4">
                ...
                <div class="row-fluid col-md-4">
                 ...
                 <div class="form-group">
                    ...
                    <div id="addcgtinfo" style="color:#0b33a2">

                    <div class="form-group">
                    <label for="amnt">CGT Rate:</label>
                    <input type="text"  name="cgtrate" id="cgtrate" placeholder="CGT Rate" value="<?php echo $cgtrate?>" onchange="makenum('cgtrate')" size="2" >
                     <label for="">%</label><br><br>
                    <label for="amnt">Display Transaction Amount?</label>
                    <select name="cgttnx" id="cgttnx" onchange="java_script_:showPaid3(this.options[this.selectedIndex].value)">
                    ...
                    <div id="cgtpaid" style="display:none;color:#ef2323">

                    <div class="form-group">
                    <label for="amnt">CGT Already paid:</label>
                    <input type="text" class="form-control" name="cgtamtpaid" id="cgtamtpaid" placeholder="Amount Already paid" value="0.00" onchange="makenum('cgtamtpaid')" >
                    <br>
                    <label for="amnt">Include Penalty &amp; Interest @ <?php echo $rate ?>%:</label>&nbsp;&nbsp;<input type="checkbox" name="penintcgt" id="penintcgt" placeholder="penalty" >
...
function validateForm() {
    ...
    var m = document.forms["returns"]["cgtrate"].value;


    if (m == 0.00) {
        alert("Enter a valid CGT Rate ");
        document.forms["returns"]["cgtrate"].value="<?php echo $cgtrate?>";
        return false;
    }
    if (x == "") {
...
function showPaid3(aval) {
    if (aval == "yes") {
    cgtpaid.style.display='inline-block';
    Form.fileURL.focus();
    }
    else{
    cgtpaid.style.display='none';
    }
