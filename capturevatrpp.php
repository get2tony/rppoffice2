...
if(n=="" ||n==null ){
 //document.getElementById("coytin").value="";
    ...
    document.getElementById("vamt").value= decodeURIComponent(a);
...
<body onload="reboot();">
   <div class="container-fluid">
           <div class="note2" ><h3> &nbsp;Raise Registered Assessments (Value Added Tax)</h3>
            </div>
       ...
       <div class="row-fluid col-md-4">
             ...
             <div class="row-fluid col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="amnt" style="color:red">Less:&nbsp;&nbsp; Amount already Paid:</label>&nbsp;&nbsp;&nbsp;&nbsp;
...
if (aval=="CIT" || aval=="EDT" ||  aval=="POL" || aval=="TP" ) {
        let m=document.getElementById("coytin").value;
        let n=document.getElementById("tax").value;
        let o=document.getElementById("user").value;
   	    let p=document.getElementById("usersno").value;
   	    let a=document.getElementById("vamt").value;
   	    let y=document.getElementById("yoa").value;
           let z='';
