...
$status=checkUserstatus2($usersno,$conn);
...
<body>
   <div id="showArea" class="container-fluid">
          ...
          <form name="deleteform2" action="dodeleteass " method="post">
            <div id="verify">
              <div class="row-fluid col-md-4">
                ...
                <a target="dframe" href="tableuser?user=<?php echo $suser ?>&usersno=<?php echo $usersno ?>&status=<?php echo $status ?>" class="btn btn-default"> Go Back</a>
   ...
   <script>
    ...
    if (conf== true){
       document.deleteform2.action = "dodeleteass ";
