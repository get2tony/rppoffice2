...
<body>
   <div id="showArea" class="container-fluid">
          ...
          <form name="deleteform2" action="" method="post">
            <div id="verify">
              <div class="row-fluid col-md-4">
                ...
                <div class="row-fluid col-md-4">
                <a target="dframe" href="tablegov?sno=<?php echo $usersno ?>&status=<?php echo $status ?>&type=<?php echo $type ?>" class="btn btn-default"> Go Back</a>
