...
<body>
   <div id="showArea" class="container-fluid">
    ...
    <p></p>
               ...
               if ($status=='user') {
                 echo ' <a target="dframe" href="tableuser?usersno='.$usersno.'&user='.$suser.'&status='.$status.'" class="btn btn-default"> Go Back</a>';
               }else {
                  echo ' <a target="dframe" href="tableuser2?usersno='.$usersno.'&user='.$suser.'&status='.$status.'" class="btn btn-default"> Go Back</a>';
               }
