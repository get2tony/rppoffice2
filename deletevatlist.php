...
<body>
   <div class="container-fluid" style="background:#FFFAFA">
           <div class="note2" ><h3> &nbsp;DELETE VAT FILER'S RECORD</h3>
            </div>
            <form id="returns" name="returns" action="dodeletevatlist" onsubmit="return validateForm()" method="post">
...
<script>
    ...
    if (conf== true){
       document.returns.action = "dodeletevatlist ";
