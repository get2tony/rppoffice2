...
$result=mysqli_query($conn,$query);
                   ...
                   if ($result){
                   	$msg="The Assessment has been Approved Successfully !";
    	     
	                  header("Location: tableapp?catb=".$catb."&sno='.$usersno.'&msg=".$msg."&user=".$suser."&status=".$status);
	     	  	
                          }else {
    	
                    $msg2="Sorry! Unable to Approve the Assessment";
	                header("Location: tableapp?catb=".$catb."&sno='.$usersno.'&msg=".$msg2."&user=".$suser."&status=".$status);
