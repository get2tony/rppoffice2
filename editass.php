...
if($taxtype=='WHT' ){
	if ($tprofit==$amount && strpos( $assprofit,"_N" ) == false) {
        $assprofit=$assprofit.'_N';
    }
	
}

if($taxtype!='EDT' && $taxtype!='CIT' && $taxtype!=='WHT'){
   ...
   <div class="container-fluid">
       ...
       <div class="row-fluid col-md-4">
                ...
                <div class="row-fluid col-md-4">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="" name="amount" placeholder="Amount Raised" 
                    value="<?php 
                    ...
                    echo "<option >Additional Tax</option>
                     ...
                     <div class="form-group">
                    <label for="penalty">Penalty Inclusive?:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <select name="penal" id="peny" >
                        <option ><?php 
                        if ($penalty=='on') {
                           echo 'Yes';
                        }else {
          ...
          <input type="text" class="" name="amtpaid" placeholder="Amount Paid" value="<?php 
                   ...
                   <div class="form-group">
                    <label for="cittxt" id="ass">Assessable Profit:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" class="" name="assprofit" placeholder="Ass profit" value="<?php 
						   ...
						   echo $assprofit ?>" size="21">
					</div>
                   <div class="form-group">
                    <label for="cittxt" id="tpt">Total Profit:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" class="" name="tprofit" placeholder="total profit" value="<?php 
						    $tprofit=number_format(str_replace(',','',$tprofit),2);
						   echo $tprofit ?>" size="21">
					</div>
			</div>        
                   <div class="form-group">
...
var n = d.getFullYear();
   ...
   function checkWHT() {
     ...
     if (d=='WHT') {
        document.getElementById("ass").innerHTML='WHT Rate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
        document.getElementById("tpt").innerHTML='Transaction';
     }  
   }                 
