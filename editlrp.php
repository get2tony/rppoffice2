    ...
    <section id= "form">
     <div class="container-fluid">
       <div class="bootstrap-iso">
        <form  name="returns" action="doeditlrp " onsubmit="return validateForm()" method="post">
       <div class="row-fluid col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input name="yoa" id="" value="<?php   echo $assyr ?>"  />
 ...
 <div class="row-fluid col-md-4">
                ...
                <?php
                   ...
                   if ($errormsg2==null){
                    ...
                    The LRP Due is now <b>N '.$amtmsg.'</b>
                    </h4>
            ...
            if($defmsg=='0' && $amtmsg=='0.00' ){
                    ...
                    Kindly Note that this Returns is no longer Late: Please Delete Assessment Now !<br/><br/> <a class="btn btn-danger" href="deletelrp?tin='.$coytin.'&yrend='.$yrend.'&user='.$suser.'&tab='.$table.'&sno='.$sno.'">Delete this LRP Assessment</a>
                    </h4>
