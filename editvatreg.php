...
<body>
   <div class="container-fluid">
           <div class="note2" ><h3> &nbsp;EDIT (VAT) Self Assessment</h3>
            </div>
            <form id="returns" name="returns" action="doeditvatreg" onsubmit="return validateForm()" method="post">
       <div class="row-fluid col-md-4">
                <div class="form-group">
                     <div class="alert-success" id="screen"><h3><label for="">Assigned Assessment No:</label></h3><h3> <?php echo $asmno ?></h3></div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="amnt">Days of Default :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" id="date" class="" name="daylate" placeholder="Days Late" value="<?php echo $defualt; ?>">
                    </div>
