...
$sql="SELECT * FROM $table WHERE capdate LIKE '%".$yoa."%' && `approval` LIKE 'approved' ORDER BY asmtno ASC";
}
if ($term=="all"){
...
$sql="SELECT * FROM $table WHERE capdate LIKE '%".$yoa."%' && `approval` LIKE 'approved' ORDER BY asmtno ASC";
 ...
 if($term=="cit"){ 
      $showterm="CIT Raised";
$sql="SELECT * FROM `$table` WHERE `taxtype` like 'CIT' && capdate like '%".$yoa."' && `approval` LIKE 'approved' ORDER BY asmtno ASC";
 }
if($term=="edt"){ 
      $showterm="EDT Raised";
$sql="SELECT * FROM `$table` WHERE `taxtype` like 'EDT' && capdate like '%".$yoa."' && `approval` LIKE 'approved' ORDER BY asmtno ASC";
 }

if($term=="vat"){ 
      $showterm="VAT Raised";
$sql="SELECT * FROM `$table` WHERE `taxtype` like 'VAT' && capdate like '%".$yoa."' && `approval` LIKE 'approved' ORDER BY asmtno ASC";
 }

if($term=="pol"){ 
      $showterm="POL Raised";
$sql="SELECT * FROM `$table` WHERE `taxtype` like 'POL' && `approval` LIKE 'approved' && capdate like '%".$yoa."'";
 }
if($term=="boj"){ 
      $showterm="BOJ Raised";
$sql="SELECT * FROM `$table` WHERE `basis` like 'BOJ' && `approval` LIKE 'approved' && capdate like '%".$yoa."' ";
 }
...
<body>
   ...
   <div id="verify">
    <form name="search" action="govsasearch2 "  method="post">
