...
<html>
    <head>
        ...
        <link rel="stylesheet" href="sidebarset.css">
 ...
 function hideLoader() {
                    ...
                    <div class="container create">
                        ...
                        <div class="logo">
                            ...
                            <a title="Approved Asmts" href="tableuser?sno=<?php echo $sno ?>&status=<?php echo $userstatus?>&user=<?php echo $suser?>" target="dframe" class="btn btn-primary">
  								<?php echo date('Y')?> Assessments &nbsp;<span id="show2" class="badge badge-light"></span>
								</a>
                            ...
                            <?php 
								...
								<a  title="Pending Approval" id="def" href="tableapp?sno='.$sno.'&status='.$userstatus.'&user='.$suser.'"  target="dframe" class="btn btn-default" onfocus="dobutton()">
    ...
    function fillstuff() {
        ...
        //     $(document).ready(function () {
        //     var idleInterval = setInterval("dobutton()", 900); 
