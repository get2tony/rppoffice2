...
if($term==''){
    ...
    $term=date('Y');
$sql="SELECT * FROM $table WHERE  (niltax like 'Yes' || cit<1 ) && yoa like '".$term."'  ORDER BY capdate DESC";
}else{
...
<body>
   ...
   <div id="verify">
    <form name="search" action="nilsearchyoa "  method="post">
       
                
                    <label for="">Search For NIL Filers by YOA:</label>
