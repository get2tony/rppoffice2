 ...
 if($table!='lrps'){                 
                  ...
                  $result=mysqli_query($conn,$query);
                   ...
                   if ($result){
	                  ...
	                  header("Location: tableapp?sno=".$usersno."&catb=".$catb."&msg=".$msg."&user=".$suser."&status=".$status);
	     	  	
                          }else {
    	
                    $msg2="Sorry! Unable to Reject all the Assessment";
	                header("Location: tableapp?sno=".$usersno."&catb=".$catb."&msg=".$msg2."&user=".$suser."&status=".$status);
