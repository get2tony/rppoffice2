...
$amt='';
$amt2='';
$showlabel='<div class="text-center"><h3>RPP COMPLIANCE TEMPLATE </h3></div>';
        ...
        while ($row = mysqli_fetch_array($query))
        {
            ...
            echo '<tr>
                 ...
                 for ($i=$showyr; $i>=0; $i--) { 
                    ...
                    $aprofit=getcurrentinfo3($conn,$tinno,$day[$i]);
                    $tprofit=getcurrentinfo4($conn,$tinno,$day[$i]);
                    $citpaid=getcurrentinfo($conn,$tinno,$day[$i]);
                    $edtpaid=getcurrentinfo5($conn,$tinno,$day[$i]);
                    $cost=getcurrentinfo6($conn,$tinno,$day[$i]);
                    $fa=getcurrentinfo7($conn,$tinno,$day[$i]);
                    $lrp=getcurrentinfo8($conn,$tinno,$day[$i]);
                    $capture=getcurrentinfo9($conn,$tinno,$day[$i]);
                    ...
                    //     $edtpaid=$edtpaid;
                    // }
                    $ca=(str_replace(',', '', $aprofit) - str_replace(',', '', $tprofit));
                     if ($ca<1) {
                        $ca=0;
                     }
