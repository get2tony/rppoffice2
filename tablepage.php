...
$ddate=date('Y');
$sql= "SELECT * FROM $table WHERE capdate LIKE '%".date('Y')."%' || yoa LIKE '%".date('Y')."%' ORDER BY sno DESC";
...
$showlabel='<div class="text-center"><h3>'.$ddate.' '.strtoupper(str_replace("_"," ",$table)).' SELF ASSESSMENT REGISTER</h3></div>';
