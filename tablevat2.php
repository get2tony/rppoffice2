	...
	<div>
		<div class="row main">
			...
			<div id="showcount" class="text-center">
				<font color="red"><?php echo $total_pages ?> Record(s) Found</font>
			</div><br>
			<div class="col-lg-4">&nbsp;<button class="btn btn-primary"> Export Page to Excel</button>&nbsp;<a href="tablevat44" class="btn btn-primary"> Export Compliance</a></div>
			<div class="col-lg-4">
	...
	<script>
		$("button").click(function() {
			$("#table2excel").table2excel({
				...
				name: "Worksheet Name",
				filename: "VAT Compliance", // do include extension
