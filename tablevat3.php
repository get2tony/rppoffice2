...
if (!$query1) {
    ...
    $sql = 'SELECT DISTINCT * FROM temp_self GROUP BY tinno ORDER BY coyname ASC';
}
...
//    $sql= SELECT * FROM `vatreg` GROUP BY tinno ORDER BY coyname ASC
...
$amt = '';
$amt2 = '';
$showlabel = '<div class="text-center"><h3>' . $ddate . ' VAT COMPLIANCE REGISTER</h3></div>';
